...
class SourceFinder:
    ...
    def source_finder(
        ...
        with open(log_file_path, "a") as file:
            ...
            file.write(f"Initial background level max : {np.max(initial_local_levels)}\n")
            file.write(f"Initial background level min : {np.min(initial_local_levels)}\n")
        ...
        with open(log_file_path, "a") as file:
            ...
            file.write(f"Final background level max : {np.max(final_local_levels)}\n")
            file.write(f"Final background level min : {np.min(final_local_levels)}\n")
